 ...
 bot.on('guildMemberAdd',(member)=>{
    const attachment = new Discord.MessageAttachment('./media/logo.png', 'logo.png');
         const exampleEmbed = new Discord.MessageEmbed()
	      ...
	      .setDescription('Hi, welcome to the server! \Supportive Spirit is a Mental Health Project aimed at building a community, stimulating discourse by creating a safe space, breaking taboos, & helping you love yourself')
         .attachFiles(attachment)
	      .setThumbnail('attachment://logo.png')
      	.addFields(
            { name: 'How to get started ?', value: "My prefix is ``!ss`` \n Type ``!ss help`` in any text channel to learn more."},
            { name: '\u200B', value: '\u200B' },
